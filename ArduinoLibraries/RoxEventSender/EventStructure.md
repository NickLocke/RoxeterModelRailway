...
The hexadecimal values of the high Nibble are as shown in the list [here](README.md). The values for the low Nibbles are defined on the approriate specific pages.
